...
const doctors = [
    { email: "raul@saludtotal.cl", password: bcrypt.hashSync("1234", 10), name: "Dr Raul Perez" },
    { email: "maria@saludtotal.cl", password: bcrypt.hashSync("5678", 10), name: "Dra Maria Lopez" },
    { email: "juan@saludtotal.cl", password: bcrypt.hashSync("abcd", 10), name: "Dr Juan Martinez" }
];
